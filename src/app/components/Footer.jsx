      ...
      <div className="container mx-auto px-4">
        ...
        >
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="w-10 h-10 bg-[#e1ccad] text-[#00927c] rounded-full flex items-center justify-center hover:bg-white transition-colors duration-300"
          ...
          {footerLinks.map((column, columnIndex) => (
            ...
            >
              <h3 className="text-xl font-bold mb-6 text-[#e1ccad]">{column.title}</h3>
              <ul className="space-y-3">
                {column.links.map((link, linkIndex) => (
                  ...
                  >
                    <Link 
                      href={link.url} 
                      className="inline-block text-white hover:text-[#e1ccad] transition-colors duration-300 py-1"
                    >
                      {link.text}
                    </Link>
                  </motion.li>
        ...
        <motion.div 
          className="h-px my-10 bg-gradient-to-r from-transparent via-[#e1ccad]/40 to-transparent"
        ...
        {/* Copyright */}
        <motion.div 
          className="text-center text-sm text-gray-100 flex flex-col space-y-3"
