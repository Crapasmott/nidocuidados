      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-start">
          ...
          <div className="md:w-1/2 mb-12 md:mb-0">
            <span className="text-primary font-medium mb-2 inline-block">¿Quieres saber más?</span>
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-gray-800 mb-6">Ponte en contacto con nosotras</h2>
          ...
          {/* Lado derecho - puede ser una imagen o información de contacto */}
          <div className="md:w-1/2 md:pl-12">
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <div className="mt-8">
                <h4 className="font-medium mb-3">Síguenos en nuestras redes</h4>
